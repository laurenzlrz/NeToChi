...
class SAState:
	...
	def __init__(self, mapping_input: MosaicMappingInput):
		...
		if mapping_input.assignment is None:
			...
			self.core_assignment: npt.NDArray[np.int_] = initial_flat_slots // hw_config.neurons_per_core
			self.local_assignment: npt.NDArray[np.int_] = initial_flat_slots % hw_config.neurons_per_core
		else:
			core_assignment = mapping_input.assignment.neuron_core_pre_assignment
