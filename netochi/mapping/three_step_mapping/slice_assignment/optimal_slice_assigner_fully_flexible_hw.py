...
from netochi.mapping.three_step_mapping.interfaces import HierarchicalClusterOutput, SliceAssignerFlexibleHw
...
class OptimalSliceAssigner(SliceAssignerFlexibleHw):
